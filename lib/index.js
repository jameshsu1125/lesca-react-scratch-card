...
define(["require", "exports", "react/jsx-runtime", "react", "./mise"], function (require, exports, jsx_runtime_1, react_1, mise_1) {
    ...
    var ScratchCard = function (_a) {
        var cover = _a.cover, percent = _a.percent, onComplete = _a.onComplete, children = _a.children;
        var ref = (0, react_1.useRef)(document.createElement('canvas'));
        // Basic HTMLElement
        var _b = (0, react_1.useState)({ width: 0, height: 0 }), size = _b[0], setSize = _b[1];
        var _c = (0, react_1.useState)(false), canvasVisible = _c[0], setCanvasVisible = _c[1];
        var _d = (0, react_1.useState)('none'), display = _d[0], setDisplay = _d[1];
        var _e = (0, react_1.useState)(), image = _e[0], setImage = _e[1];
        ...
        (0, react_1.useEffect)(function () {
            if (image) {
                var canvas = ref.current;
                if (canvas) {
                    (0, mise_1.drawImage)(canvas, image);
        ...
        return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: 'LescaScratchCard', style: __assign(__assign({ position: 'relative' }, size), { display: display }) }, { children: [children, size.width !== 0 && size.height !== 0 && canvasVisible && ((0, jsx_runtime_1.jsx)("canvas", { ref: ref, style: { position: 'absolute', backgroundColor: 'transparent', top: 0, left: 0 }, width: size.width, height: size.height }))] })));
    };
