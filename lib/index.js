...
define(["require", "exports", "react/jsx-runtime", "react", "./mise"], function (require, exports, jsx_runtime_1, react_1, mise_1) {
    ...
    var ScratchCard = function (_a) {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: 'LescaScratchCard', style: { position: 'relative', width: width, height: height, display: display } }, { children: [children, canvasVisible && ((0, jsx_runtime_1.jsx)("canvas", { ref: ref, width: width, height: height, style: { position: 'absolute', backgroundColor: 'transparent', top: 0, left: 0 } }))] })));
    };
