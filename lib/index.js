define(["require", "exports", "react/jsx-runtime", "react", "./mise"], function (require, exports, jsx_runtime_1, react_1, mise_1) {
    "use strict";
    ...
    var ScratchCard = function (_a) {
        var cover = _a.cover, percent = _a.percent, onComplete = _a.onComplete, width = _a.width, height = _a.height, children = _a.children;
        var ref = (0, react_1.useRef)(document.createElement('canvas'));
        // Basic HTMLElement
        var _b = (0, react_1.useState)(false), canvasVisible = _b[0], setCanvasVisible = _b[1];
        var _c = (0, react_1.useState)('none'), display = _c[0], setDisplay = _c[1];
        var _d = (0, react_1.useState)(), image = _d[0], setImage = _d[1];
        var isDrawing = (0, react_1.useRef)(false);
        var lastPoint = (0, react_1.useRef)({ x: 0, y: 0 });
        var destory = function (canvas) {
        ...
        var handleMouseDown = function (event) {
            ...
            lastPoint.current = (0, mise_1.getMouse)(event, ref.current);
        };
        var handleMouseMove = function (event) {
            ...
            var currentPoint = (0, mise_1.getMouse)(event, ref.current);
            var dist = (0, mise_1.distanceBetween)(lastPoint.current, currentPoint);
            var angle = (0, mise_1.angleBetween)(lastPoint.current, currentPoint);
            // console.log(dist, angle, currentPoint);
            var canvas = ref.current;
            var ctx = canvas.getContext('2d');
            Array.from(Array(Math.floor(dist)).keys()).forEach(function (i) {
                var _a = lastPoint.current, x = _a.x, y = _a.y;
            ...
            ctx === null || ctx === void 0 ? void 0 : ctx.clearRect(0, 0, 200, 200);
            lastPoint.current = currentPoint;
            var p = (0, mise_1.getFilledInPixels)(32, canvas, canvas.width, canvas.height);
            if (p && p >= percent) {
        ...
        (0, react_1.useEffect)(function () {
            if (image) {
                var canvas = ref.current;
                if (canvas) {
                    (0, mise_1.drawImage)(canvas, image, width, height);
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { className: 'LescaScratchCard', style: { position: 'relative', width: width, height: height, display: display }, children: [children, canvasVisible && ((0, jsx_runtime_1.jsx)("canvas", { ref: ref, width: width, height: height, style: { position: 'absolute', backgroundColor: 'transparent', top: 0, left: 0 } }))] }));
    };
