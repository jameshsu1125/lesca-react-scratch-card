...
import { drawImage, getMouse, distanceBetween, angleBetween, getFilledInPixels } from './mise';
...
const ScratchCard = ({ cover, percent, onComplete, children }: ScratchProps) => {
  ...
  return (
    <div className='LescaScratchCard' style={{ position: 'relative', ...size, display }}>
      {children}
      {size.width !== 0 && size.height !== 0 && canvasVisible && (
        <canvas
          ref={ref}
